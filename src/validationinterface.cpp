...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.UpdatedAddress.connect(boost::bind(&CValidationInterface::UpdatedAddress, pwalletIn, _1, _2, _3));
}
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.UpdatedAddress.disconnect(boost::bind(&CValidationInterface::UpdatedAddress, pwalletIn, _1, _2, _3));
}
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.UpdatedAddress.disconnect_all_slots();
}
